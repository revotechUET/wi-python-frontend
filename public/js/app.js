...
module.exports = "<div class=terminal> <div ng-if=!self.codeOrIframe ng-bind-html=self._resultHtml></div> <iframe ng-if=self.isResultAIframe src={{self._iframeHtmlLink}} frameborder=0> </iframe> </div>";
